...
- (void)_resignDefaultAddressInEmailAliases:(id)arg1 indexOfOldDefaultAlias:(unsigned long long)arg2 indexOfOldDefaultAddress:(unsigned long long)arg3 indexOfNewDefaultAlias:(unsigned long long)arg4 newDefaultAlias:(id)arg5 newDefaultAddresses:(id)arg6;
